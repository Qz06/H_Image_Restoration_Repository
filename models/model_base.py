...
class ModelBase():
    def __init__(self, opt):
        ...
        use_cuda = torch.cuda.is_available() and bool(opt.get('gpu_ids'))
    ...
    def load_network(self, load_path, network, strict=True, param_key='params'):
        ...
        if strict:
            ...
            state_dict_old = torch.load(load_path, map_location='cpu')
    ...
    def load_optimizer(self, load_path, optimizer):
        if torch.cuda.is_available():
            ...
            map_location = 'cpu'
        optimizer.load_state_dict(torch.load(load_path, map_location=map_location))
