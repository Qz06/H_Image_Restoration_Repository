...
def define_G(opt):
    ...
    # ----------------------------------------
        ...
        netG = net(upscale=opt_net.get('upscale', opt_net.get('scale', 1)),
                   ...
                   qkv_bias=opt_net.get('qkv_bias', True),
                   qk_scale=opt_net.get('qk_scale', None),
                   drop_rate=opt_net.get('drop_rate', 0.0),
                   attn_drop_rate=opt_net.get('attn_drop_rate', 0.0),
                   drop_path_rate=opt_net.get('drop_path_rate', 0.1),
                   ape=opt_net.get('ape', False),
                   patch_norm=opt_net.get('patch_norm', True),
